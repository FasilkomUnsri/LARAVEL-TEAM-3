...
<head>
  ...
  <title>Garudaschool - <?php echo e($title ?? ''); ?></title>
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="<?php echo e(asset('templates/backend/AdminLTE-3.0.1')); ?>/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo e($contentTitle ?? ''); ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <?php echo e(date('Y')); ?> team-3 .</strong>
    All rights reserved.
  </footer>
...
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo e(asset('templates/backend/AdminLTE-3.0.1')); ?>/plugins/jquery-ui/jquery-ui.min.js"></script>
...
<!-- overlayScrollbars -->
<script src="<?php echo e(asset('templates/backend/AdminLTE-3.0.1')); ?>/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
<!-- AdminLTE App -->
<script src="<?php echo e(asset('templates/backend/AdminLTE-3.0.1')); ?>/dist/js/adminlte.js"></script>
<?php echo $__env->yieldPushContent('js'); ?>
</body>
</html><?php /**PATH C:\xampp\htdocs\laraschool-master\resources\views/layouts/backend/app.blade.php ENDPATH**/ ?>