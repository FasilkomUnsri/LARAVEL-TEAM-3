	...
	<div class="col">
		<div class="card">
			<div class="card-header">
				<a href="<?php echo e(route('admin.users.create')); ?>" class="btn btn-primary btn-sm">Tambah Data</a>
			</div>
			<div class="card-body table-responsive">
				...
				<tr>
				  ...
				  <td>
				  	<div class="row ml-2">
				  		<a href="<?php echo e(route('admin.users.edit',$user->id)); ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laraschool-master\resources\views/admin/users/index.blade.php ENDPATH**/ ?>