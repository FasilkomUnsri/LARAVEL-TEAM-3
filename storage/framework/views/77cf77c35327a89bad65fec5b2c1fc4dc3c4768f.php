    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <a href="<?php echo e(route('admin.artikel.create')); ?>" class="btn btn-primary btn-sm">Tambah Data</a>
            </div>
            <div class="card-body table-responsive">
                ...
                <tr>
                  <td><?php echo e($no++); ?></td>
                  <td><?php echo e($art->judul); ?></td>
                  <td><?php echo e($art->user->name); ?></td>
                  <td><?php echo e($art->kategoriArtikel->nama_kategori); ?></td>
                  
                  <td>
                    <?php if(auth()->user()->id == $art->user_id): ?>
                    <div class="row ml-2">
                        <a href="<?php echo e(route('admin.artikel.edit',$art->id)); ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a>
                        
                        <form method="POST" action="<?php echo e(route('admin.artikel.destroy',$art->id)); ?>">
                            <?php echo csrf_field(); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laraschool-master\resources\views/admin/artikel/index.blade.php ENDPATH**/ ?>